...
This lecture goes over the [topics covered](https://www2.isye.gatech.edu/isye6420/plan.html) in the course. Here are some notes about each homework and the corresponding units.
...
This is where we start using Probabilistic Programming Languages (PPLs) like BUGS, [Stan](../index.qmd), or [PyMC](https://areding.github.io/6420-pymc/intro.html). We start with linear regression and move into hierarchical models.
